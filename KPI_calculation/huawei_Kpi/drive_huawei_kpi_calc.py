from KPI_calculation.huawei_Kpi import huawei_app
#.app import parse_input_xml, write_to_excel, read_mandatory_kpi
import argparse
import os 
import re
...
def run_huawei_lte_kpi_calc(Input_folder, output_folder,filter_file):
    mandatory_kpi = huawei_app.read_mandatory_kpi(filter_file)
    print("Mandatory KPIs are {}".format(mandatory_kpi))
    input_dict = {}
